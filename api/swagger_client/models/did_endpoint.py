...
class DIDEndpoint(object):
    ...
    def __init__(self, did=None, endpoint=None, _configuration=None):  # noqa: E501
        """DIDEndpoint - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def did(self):
        """Gets the did of this DIDEndpoint.  # noqa: E501

        DID of interest  # noqa: E501

        :return: The did of this DIDEndpoint.  # noqa: E501
        :rtype: str
        """
        return self._did
    ...
    @did.setter
    def did(self, did):
        """Sets the did of this DIDEndpoint.

        DID of interest  # noqa: E501

        :param did: The did of this DIDEndpoint.  # noqa: E501
        :type: str
        """
    ...
    @property
    def endpoint(self):
        """Gets the endpoint of this DIDEndpoint.  # noqa: E501

        Endpoint to set (omit to delete)  # noqa: E501

        :return: The endpoint of this DIDEndpoint.  # noqa: E501
        :rtype: str
        """
    ...
    def endpoint(self, endpoint):
        """Sets the endpoint of this DIDEndpoint.

        Endpoint to set (omit to delete)  # noqa: E501

        :param endpoint: The endpoint of this DIDEndpoint.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DIDEndpoint, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DIDEndpoint):
            return False
